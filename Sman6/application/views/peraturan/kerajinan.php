    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h4 class="page-header">Tabel Deskripsi Peraturan Kerajinan</h4>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <a href="<?php echo site_url()?>/bk/form_input_kerajinan"><i class="fa fa-plus fa-fw"></i>Tambah Data Peraturan</a>
                                    <thead>
                                        <tr style="font-family: Cambria,"Times New Roman",serif;>
                                            <th>No</th>
                                            <th>Deskripsi Peraturan</th>
                                            <th>Poin Peraturan</th>
                                            <th>Tanggal Berlaku Peraturan</th>
                                    ...
                                    <tbody>    
                                        ...
                                        <tr class="odd gradeX" style="font-family: Cambria,"Times New Roman",serif;>
                                            ...
                                            <td><?php echo $row->deskripsiKerajinan;?></td>
                                            <td><?php echo $row->poinKerajinan;?></td>
                                            <td><?php echo $row->tanggalBerlaku;?></td>
                                            <td align="center">
                                                <?php echo anchor('/bk/hapus_kerajinan/'.$row->idKerajinan,
                                                '<em class="fa fa-eraser" title="Hapus Data"></em>'); ?> 
                                                
                                                <?php echo anchor('/bk/updateKerajinan/'.$row->idKerajinan,
