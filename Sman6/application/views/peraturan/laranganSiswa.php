    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h4 class="page-header">Tabel Deskripsi Peraturan Larangan Siswa</h4>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <a href="<?php echo site_url()?>/bk/form_input_laranganSiswa"><i class="fa fa-plus fa-fw"></i>Tambah Data Peraturan</a>
                                    <thead>
                                    ...
                                    <tbody>    
                                        ...
                                        <tr class="odd gradeX" style="font-family: Cambria,"Times New Roman",serif;>
                                            ...
                                            <td align="center">
                                                <?php echo anchor('/bk/hapus_laranganSiswa/'.$row->idLaranganSiswa,
                                                '<em class="fa fa-eraser" title="Hapus Data"></em>'); ?> 
                                                
                                                <?php echo anchor('/bk/updateLaranganSiswa/'.$row->idLaranganSiswa,
