                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    <form role="form" action="<?php echo base_url();?>index.php/bk/update_data_db_laranganSiswa" method="post">
                                    ...
                                    foreach($list_data->result()as $isinya) { ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="idLaranganSiswa" readonly placeholder="" required class="form-control"  value=<?php echo $isinya->idLaranganSiswa;?>
                                        </div>
                                        </div><br>
                                        
                                        <div class="form-group">
                                            <label>Deskripsi Pelanggaran</label>
                                            <textarea name="deskripsiLaranganSiswa" placeholder="" required  class="form-control" style="height:px;padding-top:5px" ><?php echo $isinya->deskripsiLaranganSiswa;?></textarea>
                                        </div>
                                                                        
                                        <div class="form-group">
                                            <label>POIN PELANGGARAN</label>
                                            <input name="poinLaranganSiswa" placeholder="" required class="form-control"  value=<?php echo $isinya->poinLaranganSiswa;?>
