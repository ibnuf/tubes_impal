        ...
        <!--  page-wrapper -->
          <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h4 class="page-header">Update Data Peraturan Pelanggaran Kerapian</h4>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    <form role="form" action="<?php echo base_url();?>index.php/bk/update_data_db_kerapian" method="post">
                                    ...
                                    foreach($list_data->result()as $isinya) { ?>
										...
										<div class="form-group">
                                            ...
                                            <input name="idKerapian" readonly placeholder="" required class="form-control"  value=<?php echo $isinya->idKerapian;?>
                                        </div>
                                        </div><br>
                                        <div class="form-group">
                                            <label>Deskripsi Pelanggaran</label>
                                            <textarea name="deskripsiKerapian" placeholder="" required  class="form-control" style="height:px;padding-top:5px" ><?php echo $isinya->deskripsiKerapian;?></textarea>
                                        </div>
                                                                        
                                        <div class="form-group">
                                            <label>POIN PELANGGARAN</label>
                                            <input name="poinKerapian" placeholder="" required class="form-control"  value=<?php echo $isinya->poinKerapian;?>
