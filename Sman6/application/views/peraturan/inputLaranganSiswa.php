                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    <form role="form" action="<?php echo base_url();?>index.php/bk/simpan_laranganSiswa" method="post">
										...
										<div class="form-group">
                                            ...
                                            <textarea required class="form-control" name="deskripsiLaranganSiswa" rows="3"></textarea>
                                        </div>
																		
										<div class="form-group">
                                            <label>POIN PELANGGARAN</label>
                                            <input requizred class="form-control" name="poinLaranganSiswa">
                                        </div>
