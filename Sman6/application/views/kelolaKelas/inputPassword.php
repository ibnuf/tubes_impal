        ...
        <!--  page-wrapper -->
          <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h4 class="page-header">Tambah Password Walikelas</h4>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    <form role="form" action="<?php echo base_url();?>index.php/bk/updatePassword" method="post">
                                        
                                    	<div class="form-group">
                                            <label>Password</label>
                                            <input required class="form-control" name="password">
                                            <input required class="form-control" name="idkelas" id="idkelas" value="<?php echo $idkelas?>" type="hidden">
                                        </div>							
