        ...
        <!--  page-wrapper -->
          <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h4 class="page-header">Tambah Data Guru </h4>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    <form role="form" action="<?php echo base_url();?>index.php/bk/simpan_walikelas" method="post">
                                                                
                                        <div class="form-group">
                                            <label>KELAS</label>
                                           
                                                <select class="form-control" name="namaKelas" placeholder="idkelas" required class="a">
										...
										<div class="form-group">
                                            ...
                                            <input required class="form-control" name="waliKelas">
                                        </div>
