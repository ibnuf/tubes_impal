    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h4 class="page-header">Data Surat Terkirim</h4>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <a href="<?php echo site_url()?>/bk/kirimSurat"><i class="fa fa-plus fa-fw"></i>Tambah Data Surat</a>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>    
										...
										<tr class="odd gradeX" style="font-family: Cambria,"Times New Roman",serif;>
                                            ...
                                            <td><?php echo $row->hariPertemuan;?></td>
                                            <td><?php echo $row->tanggalPertemuan;?></td>
                                            <td><?php echo $row->jamPertemuan;?></td>
                                            <td align="center">
                                                <?php if($row->berkas==""){
                                                    echo anchor('/bk/kirimSurat/'.$row->idSurat,
                                                '<em class="fa fa-upload"> Unggah Berkas </em>');
											...
											<td align="center">
												<?php echo anchor('/bk/hapus_surat/'.$row->idSurat,
												'<em class="fa fa-eraser"> Hapus Surat </em>'); ?>
												<p>				
