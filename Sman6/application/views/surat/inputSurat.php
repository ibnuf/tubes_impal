         ...
         <!--  page-wrapper -->
          <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h4 class="page-header">Tambah Data Surat Terkirim</h4>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-8">
                                <?php echo form_open_multipart('Bk/kirimSurat'); ?>
                                    <!--<form role="form" action="<?php echo site_url('Bk/kirimSurat'); ?>" method="post">-->

                                    <input class="form-control" name="idsurat" type="hidden" value="<?php echo $id?>" >
                                        
                                                               
                                      <tr>
                                         <td><label for="berkas_terpilih">Pilih Berkas :</label></td>
                                         <td> <input type="file" name="berkas_surat" size="20"/> </td>
                                      </tr>                                     
                                    
                                                                                                                                       
                                        <br>
                                        <button type="submit" class="btn btn-primary" value="submit">Submit Button</button>
