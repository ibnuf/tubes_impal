    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h4 class="page-header">Tabel Data Username Walikelas</h4>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <a href="<?php echo site_url()?>/bk/form_input_username"><i class="fa fa-plus fa-fw"></i>Tambah Data Username</a>
                                    <thead>
                                    ...
                                    <tbody>    
                                        ...
                                        <tr class="odd gradeX" style="font-family: Cambria,"Times New Roman",serif;>
                                          <td><?php echo $nomer;?></td>
                                            ...
                                            <td align="center">
                                                <?php echo anchor('/bk/hapus_username/'.$row->idUsername,
