        ...
        <!--  page-wrapper -->
          <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h4 class="page-header">Ubah Data Orang Tua Siswa</h4>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    <form role="form" action="<?php echo base_url();?>index.php/bk/update_data_db_orangTua" method="post">
                                    ...
                                    <?php           
                                     foreach($list_data->result()as $isinya) { ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="idOrangTua" readonly placeholder="" required class="form-control"  value=<?php echo $isinya->idOrangTua;?>
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label>Nama Orang Tua</label>
                                            <input name="namaOrangTua" placeholder="" required class="form-control"  value=<?php echo $isinya->namaOrangTua;?>
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label>ID Siswa</label>
                                            <input name="idSiswa" required class="form-control"  value="<?php echo $isinya->idSiswa;?>">

                                        </div>

										<div class="form-group">
                                            <label>Alamat Orang Tua</label>
                                            <textarea name="alamatOrangTua" placeholder="" required  class="form-control" style="height:px;padding-top:5px" ><?php echo $isinya->alamatOrangTua;?></textarea>
                                        </div>
																	
										<div class="form-group">
                                            <label>Kota</label>
                                            <input name="kotaOrangTua" placeholder="" required class="form-control"  value=<?php echo $isinya->kotaOrangTua;?>
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label>Provinsi</label>
                                            <input name="provinsiOrangTua" placeholder="" required class="form-control"  value=<?php echo $isinya->provinsiOrangTua;?>
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label>No Tlp Orang Tua</label>
                                            <input name="noTlpOrangTua" placeholder="" required class="form-control"  value=<?php echo $isinya->noTlpOrangTua;?>
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label>No Hp Orang Tua</label>
                                            <input name="noHpOrangTua" placeholder="" required class="form-control"  value=<?php echo $isinya->noHpOrangTua;?>
                                        </div>
