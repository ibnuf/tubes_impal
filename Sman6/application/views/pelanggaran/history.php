        ...
        <!-- end navbar side -->
            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                     <!--  page header -->
                    <div class="col-lg-12">
                        <h4 class="page-header">Data Riwayat Pelanggaran Siswa</h4>
                    </div>
                    <br>
                    <div class="form-group">
                        <form role="form" action="<?php echo base_url();?>index.php/bk/history" method="post">
                        <div class="col-sm-6">
                            <label>NIS Siswa</label>
                            <input required class="form-control" name="idSiswa" placeholder="Silahkan Masukkan NIS Siswa" >
                            <input type="submit" name="carisiswa" class="btn btn-default" value="cari">
                        </div>
                        </form>
                    </div>
                     <!-- end  page header -->
