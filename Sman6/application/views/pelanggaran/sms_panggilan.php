        ...
        <!--  page-wrapper -->
          <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h4 class="page-header">Kirim Sms </h4>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          Cek data siswa sebelum mengirim sms
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    <form role="form" action="<?php echo site_url('bk/send_sms/'.$list_data2->idSiswa);?>" method="post">

                                            <div class="form-group">
                                            <label>NIS Siswa</label>
                                            <input name="idSiswa" readonly placeholder="" required class="form-control"  value="<?php echo $list_data2->idSiswa;?>"
                                        </div>
                                        
                                     
                                        <div class="form-group">
                                            <label>Nama Siswa</label>
                                            <input name="namaSiswa" readonly placeholder="" required class="form-control"  value="<?php echo $list_data2->namaSiswa;?>">

                                        </div>  

                                        <div class="form-group">
                                            <label>Kelas Siswa</label>
                                            <input name="kelasSiswa" readonly required class="form-control"  value="<?php echo $list_data2->kelasSiswa;?>">                                        
                                            </div>

                                        <div class="form-group">
                                            <label>Jumlah Poin Siswa</label>
                                            <input name="poinPelanggaran" readonly required class="form-control"  value="<?php echo $list_data2->JumlahPoin;?>">
                                        </div>

                                        <div class="form-group">
                                            <label>No HP Orang Tua</label>
                                            <input name="noHpOrangTua" readonly required class="form-control"  value="<?php echo $list_data2->noHpOrangTua;?>">
                                        </div>

                                        </div></br>
                                       
                                            <a href="<?php echo site_url('bk/send_sms/'.$list_data2->idSiswa) ?>"><button type="submit" class="btn btn-success" value="back"><font face="Arial">Kirim SMS</font></button></a>
