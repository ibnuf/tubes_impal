            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li class="divider"></li>
                        <li><a href="<?php echo site_url()?>/Bk/logout"><i class="fa fa-sign-out fa-fw"></i> Keluar</a>
                        </li>
                    </ul>
                    <!-- end dropdown-user -->
                </li>
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-ban fa-fw"></i> Data Sikap<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                           <li>
                            <a href="<?php echo site_url()?>/bk/form_input_pelanggaran"><i class="fa fa-edit fa-fw"></i> Tambah Nilai Sikap</a>
                           </li>
                            <li>
                                <a href="<?php echo site_url()?>/bk/data_pelanggaran_siswa"><i class="fa fa-table fa-fw"></i> Data Nilai Sikap</a>
                            </li>
                            ...
                            <li>
                             ...
                             <li>
                                <a href="<?php echo site_url()?>/bk/history"><i class="fa fa-bar-chart-o"></i> History Pelanggaran</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    ...
                    <li>
                        <a href="<?php echo site_url()?>/bk/wali_kelas"><i class="fa fa-book fa-fw"> </i> Kelola WaliKelas </a>
                    </li>
                    <li>
                        <a href="<?php echo site_url()?>/bk/walas"><i class="fa fa-book fa-fw"> </i> Kelola User WaliKelas </a>
                    </li>
        ...
        <!--  page-wrapper -->
          ...
          <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h4 class="page-header">Tambah Data Username Walikelas</h4>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    <form role="form" action="<?php echo base_url();?>index.php/bk/simpan_username" method="post">
                                        
										<div class="form-group">
                                            <label>Username</label>
                                            <input required type="text" class="form-control" name="usernameajah">
                                        </div>
																		
										<div class="form-group">
                                            <label>Password</label>
                                            <input required type="text" class="form-control" name="passwordajah">
                                        </div>
                                       ...
                                       <div class="form-group">
                                            <label>Jabatan</label>
                                                <select class="form-control" name="jabatan" placeholder="jabatan" required class="a">
                                        ...
                                        <div class="form-group">
                                            <label>Kelas</label>
                                            <input required type="text" class="form-control" name="namaKelas">
                                        </div>
