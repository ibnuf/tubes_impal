    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h2 class="page-header">Tabel Data Orang Tua Siswa</h2>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <a href="<?php echo site_url()?>/bk/form_input_tamu"><i class="fa fa-plus fa-fw"></i>Tambah Data Tamu</a>
                                   <thead>
                                      ...
                                      <tbody>    
                                        ...
                                        <tr class="odd gradeX" style="font-family: Cambria,"Times New Roman",serif;>
                                          <td><?php echo $nomer;?></td>
                                            ...
                                            <td><?php echo $row->tanggalTamu;?></td>
                                            <td><?php echo $row->hubunganTamu;?></td>
                                            <td><?php echo $row->namaSiswa;?></td>
                                            <td><?php echo $row->kelas;?></td>
                                            <td><?php echo $row->keperluan;?></td>
                                            <td align="center">
                                                <?php echo anchor('/bk/hapus_tamu/'.$row->idTamu,
                                                '<em class="fa fa-eraser" title="Hapus Data"></em>'); ?> 

                                                 <?php echo anchor('/bk/updateTamu/'.$row->idTamu,
