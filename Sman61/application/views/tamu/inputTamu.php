        ...
        <!--  page-wrapper -->
          <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h2 class="page-header">Tambah Data Kunjungan Tamu</h2>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    <form role="form" action="<?php echo base_url();?>index.php/bk/simpan_tamu" method="post">

                                        <div class="form-group">
                                            <label>Nama</label>
                                            <input required class="form-control" name="namaTamu" >
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Alamat</label>
                                            <input required class="form-control" name="alamat">
                                        </div>
                                                                                
                                                                                   
                                            <input type="hidden" class="form-control" value="<?php echo date('Y-m-d'); ?>" name="tanggalPelanggaran">
                                        

                                        <div class="form-group">
                                            <label>Hubungan Dengan Siswa</label>
                                            <input required class="form-control" name="hubunganTamu">
                                        </div>

                                        <div class="form-group">
                                            <label>Nama Siswa</label>
                                            <input required class="form-control" name="namaSiswa">
                                        </div>

                                        <div class="form-group">
                                            <label>Kelas</label>
                                            <input required class="form-control" name="kelas">
                                        </div>

                                        <div class="form-group">
                                            <label>Keperluan</label>
                                            <textarea required class="form-control" name="keperluan" rows="3"></textarea>
                                        </div>
