        ...
        <!--  page-wrapper -->
          <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h4 class="page-header">Update Data Siswa Aktif</h4>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    <form role="form" action="<?php echo base_url();?>index.php/bk/update_data_db_siswa" method="post">
                                    ...
                                    <?php           
                                     ...
                                     <div class="form-group">
                                            <label>Tahun Ajaran</label>
                                                ...
                                                <select required class="form-control" name="tahunAjaran" placeholder="tahunAjaran" required class="a">
                                                    <option value="<?php echo $isinya->tahunAjaran;?>"><?php echo $isinya->tahunAjaran;?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="idSiswa" readonly placeholder="" required class="form-control"  value=<?php echo $isinya->idSiswa;?>
                                        </div>
                                        </div>

                                        <div class="form-group">
                                            <label>Nama Siswa</label>
                                            <input name="namaSiswa" placeholder="" required class="form-control"  value="<?php echo $isinya->namaSiswa;?>">

                                        </div>

                                        <div class="form-group">
                                           <label>Kelas</label>
                                                <select class="form-control" name="kelasSiswa" placeholder="kelasSiswa" required class="a">
                                                 <option value="<?php echo $isinya->kelasSiswa;?>"><?php echo $isinya->kelasSiswa;?></option>
										...
										<div class="form-group">
                                            ...
                                            <input name="jenisKelamin" placeholder="" required class="form-control"  value=<?php echo $isinya->jenisKelamin;?>
                                        </div>
                                        <br>
                                       <div class="form-group">
                                            <label>Alamat Siswa</label>
                                            <textarea name="alamatSiswa" placeholder="" required  class="form-control" style="height:px;padding-top:5px" ><?php echo $isinya->alamatSiswa;?></textarea>
                                        </div>
                                                        
                                        <div class="form-group">
                                            <label>No Hp Siswa</label>
                                            <input name="noHpSiswa" placeholder="" required class="form-control"  value=<?php echo $isinya->noHpSiswa;?>
                                        </div>
