        ...
        <!--  page-wrapper -->
          <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h4 class="page-header">Tambah Data Siswa</h4>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Silahkan isikan data siswa
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    <form role="form" action="<?php echo base_url();?>index.php/bk/simpan_siswa" method="post">
                                        <div class="form-group">
                                            <label>Tahun Ajaran</label>
                                            <select required class="form-control" id="tahunAjaran" name="tahunAjaran" placeholder="tahunAjaran" required class="a">
                                                <option value="">-- Pilih Tahun Ajaran --</option>
                                                <?php foreach ($list_ajaran as $kl) { ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input required class="form-control" name="namaSiswa" Placeholder="Nama Siswa"  >
                                        </div>
										...
										<div class="form-group">
                                            <label>Jenis Kelamin</label>
                                                ...
                                                <select required class="form-control" name="jenisKelamin" placeholder="jenisKelamin" required class="a">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea required class="form-control" name="alamatSiswa" rows="3"></textarea>
                                        </div>
