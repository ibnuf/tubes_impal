    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h4 class="page-header">Tabel Deskripsi Peraturan Kerapian</h4>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <a href="<?php echo site_url()?>/bk/form_input_kerapian"><i class="fa fa-plus fa-fw"></i>Tambah Data Peraturan</a>
                                    <thead>
                                    ...
                                    <tbody>    
                                        ...
                                        <tr class="odd gradeX" style="font-family: Cambria,"Times New Roman",serif;>
                                            ...
                                            <td><?php echo $row->deskripsiKerapian;?></td>
                                            <td><?php echo $row->poinKerapian;?></td>
                                            <td><?php echo $row->tanggalBerlaku;?></td>
                                            <td align="center">
                                                <?php echo anchor('/bk/hapus_kerapian/'.$row->idKerapian,
                                                '<em class="fa fa-eraser" title="Hapus Data"></em>'); ?> 
                                                
                                                <?php echo anchor('/bk/updateKerapian/'.$row->idKerapian,
