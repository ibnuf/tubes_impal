        ...
        <!--  page-wrapper -->
          <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h4 class="page-header">Tambah Data Peraturan Pelanggaran Kerapian</h4>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    <form role="form" action="<?php echo base_url();?>index.php/bk/simpan_kerapian" method="post">
										...
										<div class="form-group">
                                            ...
                                            <textarea required class="form-control" name="deskripsiKerapian" rows="3"></textarea>
                                        </div>
																		
										<div class="form-group">
                                            <label>POIN PELANGGARAN</label>
                                            <input required class="form-control" name="poinKerapian">
                                        </div>
