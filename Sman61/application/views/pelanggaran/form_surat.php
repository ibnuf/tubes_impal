        ...
        <!--  page-wrapper -->
          <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h4 class="page-header">Isikan Data Surat</h4>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Pastikan Mengisi Data Surat Dengan Benar
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    <form role="form" action="<?php echo base_url();?>index.php/bk/simpan_surat" method="post"> 

                                    <?php           
                                     foreach($list_data->result()as $isinya) { ?>

                                        
                                        <input name="idsiswa" type="hidden" value="<?php echo $sss?>" required class="form-control">

                                        <div class="form-group">
                                                 <input required class="form-control" value="<?php date_default_timezone_set('asia/Bangkok'); echo date('Y-m-d'); ?>" name="tanggalSurat" type="hidden">
                                         </div>

                                         <div class="form-group">
                                            <label>Alamat Pengiriman Surat</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type ="text" class="form-control" name="hariPertemuan"  placeholder="Hari Pertemuan" required />
                                        </div>


                                        <div class="form-group">
                                            <label>Tanggal Pertemuan</label>
                                             <input required type="date" class="form-control" name="tanggalPertemuan">
                                         </div

                                      
                                        <div class="form-group">
                                            <label for="jamPertemuan">Jam Pertemuan</label>
                                            <input type="time" class="form-control" id="jamPertemuan" name="jamPertemuan" placeholder="Waktu"> 
                                        </div>
