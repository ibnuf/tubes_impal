...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h4 class="page-header">Data Detail Pelanggaran Sikap</h4>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>    
										...
										<tr class="odd gradeX" style="font-family: Cambria,"Times New Roman",serif;>
											...
											<td><?php echo $row->jamPelanggaran;?></td>
                                            <td><?php echo $row->tanggalPelanggaran;?></td>
											<td><?php echo $row->jenisPelanggaran;?></td>
											<td><?php echo $row->deskripsiPelanggaran;?></td>
											<td><?php echo $row->poinPelanggaran;?></td>
                                            <td align="center">
                                            
                                            <button type="button" onclick="hapus('<?php echo $row->idPelanggaran;?>')" class="btn btn-primary btn-xs">HAPUS</button>
									...
									<?php
										$nomer=1;	
                                        foreach($list_dataa->result()as $row) { ?>
										
										Jumlah POIN &nbsp;&nbsp;   : <?php echo $row->JumlahPoin;
                                            if($row->JumlahPoin >= 35){ ?>
    											<td align="left">
                                                <a target="_BLANK" href="<?php echo site_url('bk/form_buat_surat/'.$row->idSiswa)?>"><em class="fa fa-envelope"> Buat Surat</em></a><br>
												</td>

                                                <td align="left">
                                                       <?php echo anchor('/bk/display_surat/'.$row->idSiswa,
                                                '<em class="fa fa-print"> Cetak Surat</em>'); ?>
                                                </td>

                                                <td align="left">
                                                <?php echo anchor('/bk/kirim_sms/'.$row->idSiswa,
                                                '<em class="fa fa-phone"> Kirim Sms</em>'); ?>
                                                </td>
    ...
    <script>
        ...
        function hapus(id){
            $.ajax({
                url:"<?php echo site_url('Bk/hapus_pelanggaranana/')?>/" + id,
                type : "POST",
                dataType: "JSON",
